...
function pepsico_render_office_region($group_key)
{
  ...
  if (!$region_icon && !$region_title && empty($items))
    return;
...
<div class="container">
    <section class="spv-region" aria-label="<?php echo esc_attr__('Khu vực văn phòng', 'pepsico-theme'); ?>">
        <div class="spv-region__heading">
            <?php if ($region_icon): ?>
            <img class="spv-region__icon" src="<?php echo esc_url($region_icon, $allowed_protocols); ?>" alt=""
            ...
            <article class="spv-office">
                ...
                <div class="spv-office__body">
                    ...
                    <span class="spv-office__bullet">
                        <img src="<?php echo esc_url($marker, $allowed_protocols); ?>" alt="" loading="lazy"
                            decoding="async">
                    </span>
                    <?php endif; ?>
...
for ($i = 1; $i <= 4; $i++) {
  ...
  if ($icon || $tit || $desc)
    $cards[] = ['icon' => $icon, 'title' => $tit, 'desc' => $desc];
}
...
<div class="container">
    <section class="spv-contacts" aria-label="<?php echo esc_attr__('Liên hệ', 'pepsico-theme'); ?>">
        ...
        <div class="spv-contacts__head">
            <?php if ($head_icon): ?>
            <img class="spv-contacts__head-icon" src="<?php echo esc_url($head_icon, $allowed_protocols); ?>" alt=""
                loading="lazy" decoding="async">
            <?php endif; ?>
        ...
        <div class="spv-contacts__grid">
            ...
            <article class="spv-ct">
                ...
                <div class="spv-ct__icon">
                    <img src="<?php echo esc_url($c['icon'], $allowed_protocols); ?>" alt="" loading="lazy"
                        decoding="async">
                </div>
                <?php endif; ?>
