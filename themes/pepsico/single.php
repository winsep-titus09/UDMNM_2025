...
<div class="page-meta mt-5">
  <nav class="breadcrumbs" aria-label="Breadcrumb">
    <ol class="bc-list">
        <?php foreach ($crumbs as $c): if (!$c['label']) continue; ?>
        <li class="bc-item">
            <?php if (!empty($c['url'])): ?>
