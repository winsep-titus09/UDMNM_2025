    ...
    <div class="about-us-wrapper">
        ...
        <div class="about-us-buttons">
            <a href="https://link-to-suntory.com" class="btn-about-us suntory-btn" target="_blank" rel="noopener"
                ...
                <img src="https://api.suntorypepsico.vn/assets/166272db-1730-40ae-9ac9-7dda13faf7db?width=360"
                    alt="Suntory" loading="lazy" decoding="async" />
            </a>
            <a href="https://link-to-pepsico.com" class="btn-about-us pepsico-btn" target="_blank" rel="noopener"
                ...
                <img src="https://api.suntorypepsico.vn/assets/492c0d27-79ea-491b-bae8-254849b581fc?width=360"
                    alt="PepsiCo" loading="lazy" decoding="async" />
            </a>
            <?php if (!empty($about['button_3_text'])): ?>
            <a href="#" class="btn-about-us book-btn"
                aria-label="<?php echo esc_attr__('Xem thêm', 'pepsico-theme'); ?>">
                <span><?php echo esc_html($about['button_3_text']); ?></span>
                <img src="<?php echo esc_url($arrow_icon, $allowed_protocols); ?>" alt="" class="small-icon"
        ...
        <div class="timeline-container px-5">
            <div class="timeline-left" aria-label="<?php echo esc_attr__('Mốc thời gian', 'pepsico-theme'); ?>">
                <ul class="timeline-years">
                    ...
                    <li class="timeline-year <?php echo $i === 0 ? 'active' : ''; ?>"
            ...
            <div class="timeline-content">
                <?php foreach ($timelines as $i => $t): ?>
                <div class="timeline-detail <?php echo $i === 0 ? 'active' : ''; ?>"
                    data-index="<?php echo (int) $i; ?>">
        ...
        <div id="achievementsTabs" class="achv-section" data-items-per-view="4"
            ...
            <div class="achv-strip">
                <div class="achv-track achv-loop" data-pane="t1">
                    ...
                    <div class="achv-card">
                        <?php if ($it['img']): ?>
                        <div class="achv-card-logo"><img src="<?php echo esc_url($it['img']); ?>" alt=""></div>
                        <?php endif; ?>
                        <?php if ($it['title']): ?>
