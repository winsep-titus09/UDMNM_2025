...
<main id="primary" class="site-main">
  <div class="about-us-wrapper">
    ...
    <?php if ($about = get_field('about_feature_section')): ?>
      ...
      <div class="about-us-buttons">
        <a href="https://link-to-suntory.com" class="btn-about-us suntory-btn" target="_blank" rel="noopener" aria-label="<?php echo esc_attr__('Xem Suntory', 'pepsico-theme'); ?>">
          <img src="https://api.suntorypepsico.vn/assets/166272db-1730-40ae-9ac9-7dda13faf7db?width=360" alt="Suntory" loading="lazy" decoding="async"/>
        </a>
        <a href="https://link-to-pepsico.com" class="btn-about-us pepsico-btn" target="_blank" rel="noopener" aria-label="<?php echo esc_attr__('Xem PepsiCo', 'pepsico-theme'); ?>">
          <img src="https://api.suntorypepsico.vn/assets/492c0d27-79ea-491b-bae8-254849b581fc?width=360" alt="PepsiCo" loading="lazy" decoding="async"/>
        </a>
        <?php if (!empty($about['button_3_text'])): ?>
          <a href="#" class="btn-about-us book-btn" aria-label="<?php echo esc_attr__('Xem thêm', 'pepsico-theme'); ?>">
            ...
            <img src="<?php echo esc_url($arrow_icon, $allowed_protocols); ?>" alt="" class="small-icon" loading="lazy" decoding="async"/>
          </a>
        <?php endif; ?>
      </div>
    <?php endif; ?>
  ...
  <?php    // -------- Timeline --------
    ...
    if ($achv = get_field('achievements_tabs')):
      ...
      <div class="container">
        <div id="achievementsTabs" class="achv-section" data-items-per-view="4" aria-label="<?php echo esc_attr__('Thành tựu', 'pepsico-theme'); ?>">
          <div class="achv-tabs" role="tablist" aria-label="<?php echo esc_attr__('Chuyển tab thành tựu', 'pepsico-theme'); ?>">
            <button class="achv-tab is-active" data-tab="t1" role="tab" aria-selected="true" aria-controls="pane-t1"><?php echo esc_html($tab1_label); ?></button>
            <button class="achv-tab" data-tab="t2" role="tab" aria-selected="false" aria-controls="pane-t2"><?php echo esc_html($tab2_label); ?></button>
          </div>

          <div class="achv-hero">
            <div id="pane-t1" class="achv-hero-pane" data-pane="t1" style="background-image:url('<?php echo esc_url($achv['t1_hero_bg_url']??''); ?>')">
            ...
            <div id="pane-t2" class="achv-hero-pane is-hidden" data-pane="t2" style="background-image:url('<?php echo esc_url($achv['t2_hero_bg_url']??''); ?>')">
